//Ex20.cpp : Write a function to create a linked list that is intersection of two single linked lists, i.e. it contains only the 
...
class SingleLinkedList
{
	...
	public:
		...
		void intersectionLists(SingleLinkedList &list2, SingleLinkedList &list3);
	private:
...
void SingleLinkedList::intersectionLists(SingleLinkedList &list2, SingleLinkedList &list3)
{
	Node *ptr = start;

	while(ptr!=NULL)
	{
		if(list2.isPresent(ptr->info))
